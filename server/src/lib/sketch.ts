...
export function linePrompt(horizon: string): string {
  return (
    ...
    `a single thin ink line on warm ivory paper, in the manner of a fashion-illustration croquis. ` +
...
export function colorPrompt(): string {
  return (
    ...
    `lavender #A38CB4, warm gold #D7A83C, dusty rose #E28C9B, and a little sage #8FB3A0. Leave plenty ` +
    `of paper untouched.`
  );
}
