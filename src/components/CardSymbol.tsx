...
export const STROKES: Record<string, string[]> = {
  ...
  // A stone set down on the ground. Faceted, not rounded — a smooth pebble
  // with anything above it reads as fruit. This is the road that opens by
  // putting something down rather than carrying more.
  stone: [
    "M13 47 L 18.5 32 L 30 25.5 L 43 29 L 51 40.5 L 49 47 Z",
    "M18.5 32 L 30.5 38.5 L 43 29",
    "M30.5 38.5 L 32 47",
    "M6 51 L 58 51",
  ],
