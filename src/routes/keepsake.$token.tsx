  ...
  if (state === null) {
    return (
      <div className="min-h-screen bg-dawn-sky flex items-center justify-center px-6">
        <p className="text-base italic opacity-75 font-serif">Opening the keepsake…</p>
      </div>
    );
  }
      ...
      <main className="max-w-md mx-auto px-6 pt-12 pb-16">
        ...
        <article className="relative animate-card-rise">
          ...
          <div className="relative bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl p-7 backdrop-blur-xl shadow-[0_30px_60px_-30px_rgba(45,42,46,0.18)]">
            ...
            <p className="text-[12px] uppercase tracking-[0.2em] font-medium opacity-60 mb-2">
              The vow card · drawn once, never redrawn
            </p>
            <h2 className="text-3xl font-serif font-light tracking-tight">{k.cardTitle}</h2>
            {k.cardEssence && (
              <p className="mt-1 text-base italic font-serif opacity-75">{k.cardEssence}</p>
            )}
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 text-center">
              <div className="p-3 bg-dawn-sky/60 border border-dawn-haze/15 rounded-xl">
                ...
                <p className="text-[12px] uppercase tracking-widest opacity-70 mt-1">days held</p>
              </div>
              <div className="p-3 bg-dawn-sky/60 border border-dawn-haze/15 rounded-xl">
                <p className="text-2xl font-serif italic text-dawn-haze">{k.darkNights}</p>
                <p className="text-[12px] uppercase tracking-widest opacity-70 mt-1">hard nights</p>
              </div>
              <div className="p-3 bg-dawn-sky/60 border border-dawn-haze/15 rounded-xl">
                <p className="text-lg font-serif italic text-dawn-haze leading-8">
                  {fulfilled ? "✓" : "☾"}
                </p>
                <p className="text-[12px] uppercase tracking-widest opacity-70 mt-1">
            ...
            <div className="mt-6 space-y-4">
              <div>
                <p className="text-[12px] uppercase tracking-[0.18em] opacity-70 mb-1">They endured</p>
                <p className="font-serif italic text-base leading-relaxed">“{k.enduring}”</p>
              </div>
              <div>
                <p className="text-[12px] uppercase tracking-[0.18em] opacity-70 mb-1">They hoped</p>
                <p className="font-serif italic text-base leading-relaxed">“{k.hope}”</p>
              </div>
              {k.closingNote && (
                <div>
                  ...
                  <p className="font-serif italic text-base leading-relaxed">“{k.closingNote}”</p>
                </div>
              )}
            </div>

            <p className="mt-6 pt-4 border-t border-dawn-haze/10 text-[12px] uppercase tracking-widest opacity-60 text-center">
