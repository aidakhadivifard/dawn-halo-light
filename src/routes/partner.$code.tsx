        ...
        {!stats && (
          <section className="p-6 bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl backdrop-blur-xl">
            <p className="text-sm text-dawn-ink/70 leading-relaxed">
              ...
              link and starts with <code className="text-[12px]">pk_</code>.
            </p>
            <input
              value={key}
          ...
          <section className="space-y-4 animate-card-rise">
            <div className="grid grid-cols-2 gap-3">
              <div className="p-5 bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl text-center">
                ...
                <p className="text-[9px] uppercase tracking-widest opacity-50 mt-1">people referred</p>
              </div>
              <div className="p-5 bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl text-center">
                <p className="text-3xl font-serif italic text-dawn-haze">{stats.subscribers}</p>
                <p className="text-[9px] uppercase tracking-widest opacity-50 mt-1">subscribed</p>
              </div>
              <div className="p-5 bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl text-center">
                <p className="text-3xl font-serif italic text-dawn-haze">
                  ${stats.revenueUsd.toFixed(2)}
                </p>
                <p className="text-[9px] uppercase tracking-widest opacity-50 mt-1">referred revenue</p>
              </div>
            ...
            <div className="p-5 bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl">
              <p className="text-[10px] uppercase tracking-[0.18em] opacity-50 mb-2">
                Your referral link
              </p>
              <p className="text-[13px] font-mono break-all text-dawn-ink/80">{stats.shareUrl}</p>
              <button
                onClick={copyLink}
                className="mt-3 px-6 py-2.5 bg-dawn-rose text-dawn-sky text-[10px] uppercase tracking-[0.18em] font-bold rounded-full hover:bg-dawn-haze transition-colors"
              >
