    ...
    <div className="min-h-screen bg-dawn-sky text-dawn-ink">
      <main className="max-w-md mx-auto px-6 pt-12 pb-32">
        <header className="mb-10">
          <p className="text-[12px] uppercase tracking-[0.2em] font-medium opacity-70 mb-1">Quiet preferences</p>
        ...
        <div className="bg-dawn-surface/80 border border-dawn-haze/15 rounded-2xl divide-y divide-dawn-haze/10 backdrop-blur-md">
          <div className="p-5 flex items-center justify-between">
            <div>
              ...
              <p className="text-[13px] text-dawn-ink/70">A gentle nudge each morning.</p>
            </div>
          ...
          <div className="p-5 flex items-center justify-between">
            <div>
              ...
              <p className="text-[13px] text-dawn-ink/70">When the light should reach you.</p>
            </div>
            <input type="time" value={s.reminderTime} onChange={(e) => update({ ...s, reminderTime: e.target.value })}
              className="bg-dawn-night/80 border border-dawn-haze/20 rounded-full px-3 py-1.5 text-base font-mono text-dawn-ink" />
          </div>
        </div>

        {savedMsg && <p className="mt-6 text-center text-[13px] italic opacity-75">Saved.</p>}

        <p className="mt-12 text-center text-[12px] uppercase tracking-[0.2em] opacity-55">Dawnhalo · a little light for your next step</p>
      </main>
      <BottomNav />
    </div>
  );
